    ...
    public static void winnerPickerReport(int poolID){
        try {
            ...
            DynamicReport dr = drb.addColumn("Pool ID", "PoolID", Integer.class.getName(), 30)
                    ...
                    .addColumn("Winner MemberID", "Winner", Integer.class.getName(), 30)
                    .addColumn("Picker MemberID", "Picker", Integer.class.getName(), 30)
                    .addColumn("Takeaway Date","TakeawayDate", String.class.getName(),30)
                    .addColumn("Winner Takeaway Amount", "Winner Takeaway", Double.class.getName(), 50)
                    .addColumn("Picker Takeaway Amount", "Picker Takeaway", Double.class.getName(), 50)
