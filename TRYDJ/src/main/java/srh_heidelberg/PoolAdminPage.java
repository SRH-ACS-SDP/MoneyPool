...
public class PoolAdminPage {
    ...
    private static Member poolAdmin;

    public static void AdminOperationSelect(Member adminMember) {
        System.out.println("Your Pools n Members :");
        dmlOperations.printPoolMembers(adminMember.getMemberID());
        poolAdmin = adminMember;
    ...
    private static void performSelection(int option) {
        switch (option) {
            case 1:
                ...
                if (dmlOperations.isValidPoolAdd(PoolID) & dmlOperations.isValidAdmin(PoolID,poolAdmin.getMemberID()) & dmlOperations.isValidMember(PoolID,MemberID)){
                    dmlOperations.makePaymentForMember(PoolID,MemberID);
                    PoolAdminPage.AdminOperationSelect(poolAdmin);
                }
                else{
            ...
            case 2:
                ...
                if (dmlOperations.isValidAdmin(PoolID,poolAdmin.getMemberID()) & dmlOperations.isValidPickWinner(PoolID) ) {
            ...
            case 8:
                MemberHomePortal menu = new MemberHomePortal();
                menu.welcomeMember(poolAdmin);
